globals [
  grass
  allsheep
  allwolves]  ;; keep track of how much grass there is, and sheep and wolves over time
...
to go
  ...
  if not any? sheep [ stop ] ;;added by Megan
  if not any? wolves [ stop ] ;;added by Megan
  if count turtles > 10000 [ stop ] ;;added by Megan to try to stop it from going crazy
  ask sheep [
    move
    if grass? [
  ...
  set allsheep lput count sheep allsheep
  set allwolves lput count wolves allwolves
end
...
to-report report-allsheep
  report allsheep
end

to-report report-allwolves
  report allwolves
end


to-report outputplot [r]
  let overallfilename grass?
  set overallfilename word overallfilename "-"
  set overallfilename word overallfilename initial-number-sheep
  set overallfilename word overallfilename "-"
  set overallfilename word overallfilename initial-number-wolves
  set overallfilename word overallfilename "-"
  set overallfilename word overallfilename sheep-reproduce
  set overallfilename word overallfilename "-"
  set overallfilename word overallfilename wolf-reproduce
  set overallfilename word overallfilename "-"
  set overallfilename word overallfilename sheep-gain-from-food
  set overallfilename word overallfilename "-"
  set overallfilename word overallfilename wolf-gain-from-food
  set overallfilename word overallfilename "-"
  set overallfilename word overallfilename grass-regrowth-time
  set overallfilename word overallfilename "-"
  set overallfilename word overallfilename r
  set overallfilename word overallfilename ".csv"
  export-plot "populations" overallfilename
  report overallfilename
end
