...
def read_data(filename):
	try:
		...
		for line in fd:
			split = line.split(",")
			if split[F_TGT] == TARGET and split[F_GRASS].strip() == GRASS and split[F_IND] == IND and split[F_ELITE] == ELITE and split[F_FUNCTION][:3] != "AVG":
...
data, ordering = read_data("generationdata_by_GAparameters.csv")
#print(process_data)
...
plotname = "multibar_generation_function_mutation_"+TARGET+"_"+GRASS+"_"+IND+"_"+ELITE+"noAVG.pdf"
